...
class Preprocesamiento():
    ...
    def __init__(self, path_data):
        ...
        self.df = pd.DataFrame(columns=['file_path', 'mfccs_40', 'chroma', 'mel', 'contrast',\
    ...
    def process(self, file, label):
        try:
            ...
            mfccs_40 = np.mean(librosa.feature.mfcc(y=X, \
            ...
            row = pd.Series(
                {'file_path': file, 'mfccs_40': mfccs_40, 'chroma': chroma,\
                 'mel': mel, 'contrast': contrast, \
